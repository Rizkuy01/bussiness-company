        ...
        <div className='w-full bg-[#D6BD98] py-16 px-4'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col jusutify-center'>
                    ...
                    <button className='bg-[#485B45] text-gray-50 w-[200px] rounded-md font-medium my-4 mx-auto md:mx-0 py-3 ' href='https://drive.google.com/file/d/16fa57h3LRgCHQrRaR6VPxLEa_BWkg8Cu/view?usp=drivesdk'>Cek Grand Design</button>
                </div>
            </div>
        </div>
    )
